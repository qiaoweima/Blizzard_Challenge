...
def train(rank, a, h):
    ...
    for params in optim_d.param_groups:
        params['lr'] = 1e-4
    
    for params in optim_g.param_groups:
        params['lr'] = 1e-4
        ...
        for i, batch in enumerate(train_loader):
            ...
            if rank == 0:
                ...
                if steps % a.stdout_interval == 0:
                    ...
                    print('Steps : {:d}, lr: {:0.6f}, Gen Loss Total : {:4.3f}, Mel-Spec. Error : {:4.3f}, s/b : {:4.3f}'.
                          format(steps, scheduler_g.get_lr()[0], loss_gen_all, mel_error, time.time() - start_b))
